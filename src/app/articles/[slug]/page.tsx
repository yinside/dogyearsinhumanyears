  ...
  return (
    <div className="container-main" style={{ paddingTop: '15px', paddingBottom: '30px' }}>
      <div className="breadcrumb">
        <Link href="/">Home</Link> &raquo; <Link href="/articles">Articles</Link> &raquo; {article.title}
      </div>
          ...
          <div className="section-box">
            ...
            <div className="article-content">
              ...
              <div className="related-links">
                ...
                <Link href="/articles">Browse all Breed Lifespan Articles</Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul>
              {getAllBreedSlugs()
                ...
                .map((s) => {
                  ...
                  return (
                    <li key={s}>
                      <Link href={`/articles/${s}`}>{a.breedName} Lifespan</Link>
                    </li>
                  );
                })}
              <li><Link href="/articles">View all 10 breed articles &raquo;</Link></li>
            </ul>
          </div>
